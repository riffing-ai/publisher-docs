...
<tr><td><code>current_bi_per_person</code></td><td>number</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td>Policyholder's current bodily injury limit per person in dollars, e.g. <code>30000</code> for $30k/$60k</td></tr>
...
<tr><td><code>.dui</code></td><td>boolean</td><td style={{textAlign: 'center'}}>✅</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td>Has this driver had a DUI/DWI in the past 5 years? Ping only. Default <code>false</code></td></tr>
<tr><td><code>.first_name</code></td><td>string (100)</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>✅</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td></td></tr>
