...
<tr><td><code>tcpa_language</code></td><td>string (2000)</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td>TCPA consent text shown on the form. Stored with the bid if sent on ping</td></tr>
...
<tr><td><code>.birth_date</code></td><td>string</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td><code>YYYY-MM-DD</code>. Ping: provide <code>birth_date</code> or <code>age</code> (at least one). Post: include if available — improves quoting accuracy</td></tr>
<tr><td><code>.age</code></td><td>number (15–99)</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td>Driver's age in years. Use instead of <code>birth_date</code> if PII is a concern on pings</td></tr>
