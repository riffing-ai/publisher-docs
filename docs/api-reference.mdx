...
<tr><td><code>.birth_date</code></td><td>string</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td><code>YYYY-MM-DD</code>. Provide <code>birth_date</code> or <code>age</code> (at least one)</td></tr>
