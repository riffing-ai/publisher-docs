...
<tr><td><code>traffic_channel</code></td><td>enum</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td><code>"cpc"</code> <code>"organic"</code> <code>"display"</code> <code>"social"</code> <code>"email"</code> <code>"search"</code></td></tr>
