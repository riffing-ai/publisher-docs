...
<tr><td><code>affiliate_id</code></td><td>string (64)</td><td style={{textAlign: 'center'}}>◐</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>◐</td><td style={{textAlign: 'center'}}>—</td><td><strong>Required when <code>source_type</code> is <code>"affiliate"</code>; omit when <code>"direct"</code>.</strong> Your stable identifier for the business that generated the lead — the same business must get the same ID every time</td></tr>
<tr><td><code>affiliate_name</code></td><td>string (128)</td><td style={{textAlign: 'center'}}>◐</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>◐</td><td style={{textAlign: 'center'}}>—</td><td><strong>Required when <code>source_type</code> is <code>"affiliate"</code>; omit when <code>"direct"</code>.</strong> That business's legal or DBA name, e.g. <code>"Example Quotes LLC"</code></td></tr>
