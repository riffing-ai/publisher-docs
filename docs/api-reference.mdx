...
<tr><td><code>sub_id</code></td><td>string (30)</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td><strong>Deprecated</strong> (see changelog). An opaque path, creative, or placement token within one source. Alphanumeric, hyphens, underscores</td></tr>
