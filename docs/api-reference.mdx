...
<tr><td><code>.sr_twenty_two</code></td><td>boolean</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td>Does this specific driver have an SR-22, FR-44, or similar filing? Use for per-driver detail when multiple drivers differ</td></tr>
