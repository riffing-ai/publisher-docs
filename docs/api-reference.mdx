...
<tr><td><code>language</code></td><td><code>"en"</code> / <code>"es"</code></td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>✅</td><td style={{textAlign: 'center'}}>○</td><td>English / Spanish. Required for calls</td></tr>
