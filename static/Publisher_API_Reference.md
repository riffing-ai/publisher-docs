...
<tr><td><code>sr_twenty_two</code></td><td>boolean</td><td style={{textAlign: 'center'}}>✅</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>✅</td><td style={{textAlign: 'center'}}>—</td><td>Is the policyholder required to carry an SR-22, SR-1P, FR-44, or similar state filing? FR-44 (FL, VA) and equivalent filings should be <code>true</code></td></tr>
