...
<tr><td><code>lapse_duration</code></td><td>enum</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td style={{textAlign: 'center'}}>○</td><td style={{textAlign: 'center'}}>—</td><td>How long without insurance: <code>"1-15 days"</code> <code>"16-30 days"</code> <code>"31 days - 6 months"</code> <code>"6 months - 1 year"</code> <code>"1 year - 4 years"</code> <code>"5 years or greater"</code></td></tr>
