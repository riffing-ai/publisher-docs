...
curl -X POST https://api.autobind.ai/leads/ping \
  ...
  -d '{
    ...
    "drivers": [{ "gender": "male", "birth_date": "1990-06-15", "marital_status": "married", "license_status": "active" }],
...
interface RejectedResponse {
  status: "rejected";
  reason: "invalid_bid" | "bid_expired" | "duplicate_phone" | "missing_consent_proof" | "failed_secondary_evaluation";
}
